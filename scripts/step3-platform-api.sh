...
# 1. Get RDS password
echo ""
echo ">>> [1/8] Retrieving RDS password..."
...
echo ">>> [3/8] Creating Pod Identity Association..."
...
echo ">>> [6/8] Deploying Platform API..."
